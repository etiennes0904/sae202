    ...
    <nav id="navbar">
        ...
        <ul class="menu">
            ...
            <li>
                ...
                require_once('lib.inc.php');
                if (!empty($_SESSION['utilisateur'])) {
                    echo '<a href="deconnexion.php"><img src="../images/se-deconnecter.png" width="30px"></a>';
                } else {
                    echo '<a href="connexion.php"><img src="../images/profil.png" width="30px"></a>';
                }
                ?>
            </li>
            <li>
                <?php
                if (!empty($_SESSION['utilisateur'])) {
                    echo '<a href="profil.php"><img src="'.$logo.'" width="30px"></a>';
                } else {
